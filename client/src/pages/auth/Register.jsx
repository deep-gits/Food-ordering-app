...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      toast.success('Account created! Welcome to FeastFlow 🎉');
    } catch {
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-16">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1.5">Join FeastFlow and start ordering</p>
        </div>
        ...
        <div className="card p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <button id="register-submit-btn" type="submit" disabled={loading} className="btn-primary w-full justify-center py-3">
              {loading ? (
